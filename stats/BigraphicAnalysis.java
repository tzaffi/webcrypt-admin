 ...
 */
public class BigraphicAnalysis extends Analyzor{

    /**
     * Used to show in window.
     */
    public String toString(){
	return "Bigraphic Analysis (num_bigraphs)";
    }
	...
	StringFrequency[] freqtable = mas.getMultigramFrequencies(text.toString(),2,n);
