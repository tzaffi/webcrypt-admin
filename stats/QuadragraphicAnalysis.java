 ...
 */
public class QuadragraphicAnalysis extends Analyzor{

    /**
     * Used to show in window.
     */
    public String toString(){
	return "Quadragraphic Analysis (num_trigraphs)";
    }
	...
	StringFrequency[] freqtable = mas.getMultigramFrequencies(text.toString(),4,n);
